...
RUN set -ex \
        ...
        && pip install -U git+https://github.com/tom-snow/efb-wechat-pc-slave \
        && pip3 install lottie \
        && pip3 install cairosvg \
        && sed -i 's/channel_emoji: str = "💬🖥️"/channel_emoji: str = "𝙒𝙚𝙘𝙝𝙖𝙩"/g' /usr/local/lib/python3.*/site-packages/efb-wechat-pc-slave/__init__.py \
